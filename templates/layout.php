...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__add-lot button" href="add.php">Новый лот</a>
...
<footer class="main-footer">
    <nav class="nav">
        ...
        <?php foreach ($categories as $key_cat): ?>
            <li class="nav__item">
                <a href="pages/all-lots.html"><?= $key_cat['name_category']; ?></a>
            </li>
          <?php endforeach; ?>
        </ul>
    </nav>
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" href="add.php">Новый лот</a>
